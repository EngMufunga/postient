...
// header search bar when mobile device
$('.navbar-search-responsive-btn').on('click', function () {
  $('.navbar-search').toggleClass('show');
  $('.navbar-search-responsive-btn').toggleClass('change-icon');
  $(".body-overlay").toggleClass('show');
});
$('.body-overlay').on('click', function () {
  $('.navbar-search').removeClass('show');
  $('.navbar-search-responsive-btn').removeClass('change-icon');
