...
<head>
    ...
    <title> {{ $general->site_name . ' - ' . __('404 || Page Not Found') }}</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="error__main py-60">
                        <img src="{{ getImage($activeTemplateTrue.'images/error/404.png') }}" alt="@lang('Error Image')">
                        <h2>404</h2>
                        <p>@lang('Page Not Found')</p>
