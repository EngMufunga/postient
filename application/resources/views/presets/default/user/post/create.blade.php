    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="create__post">
                ...
                <form id="postForm" action="{{ route('user.posts.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="template__radio">
                                ...
                                @foreach ($accounts as $key => $account)
                                    <div class="form-radio">
                                        ...
                                        <input class="form-check-input account-switch d-none" type="radio" name="account_id" value="{{ $account->id }}" id="account-{{ $account->name . '-' . $key }}" data-platform-id = "{{ $account->platform?->id ?? '' }}" data-platform-name="{{ $account->platform?->name }}" data-account="{{ $account }}">
                        ...
                        <div class="col-lg-12">
                            <div class="template__form">
                                <label for="post_title" class="form-label d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                    <span>
                                        @lang('Title')
                                ...
                                <input type="text" id="post_title" name="title" class="form-control post-title" placeholder="@lang('Enter a concise title')..." aria-describedby="titleHelpBlock" required>
                        ...
                        <div class="col-lg-12">
                            <div class="template__form">
                                ...
                                <textarea class="form-control post-content emoji__area" name="post_content" placeholder="@lang('Write something here')..." required>{{ old('post_content') }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                        <div class="template__form">
                                <label class="form-label">@lang('Tags')</label>
                                <input type="text" name="tags" class="form-control" value="{{ old('tags') }}" hidden>
                                <span class="hashtag-preview text--base d-none"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="create__post__widgets">
                                ...
                                <div class="create__date">
                                    ...
                                    <input type="hidden" id="schedule_datetime" name="schedule_datetime">
                                </div>
                        ...
                        <div class="col-lg-12 text-end">
                            <div class="template__form d-flex align-items-center justify-content-end gap-2 flex-wrap">
                                <button type="submit" class="btn btn--base submit-btn" data-type="post_now"><i class="fa-solid fa-paper-plane"></i> @lang('Post Now')</button>
                                @if(auth()->user()->schedule_status && auth()->user()->plan?->schedule_status)
                                <button type="submit" class="btn btn--base submit-btn" data-type="schedule_post"><i class="fa-solid fa-calendar-days"></i> @lang('Schedule Post')</button>
                                @endif
                                <button type="submit" class="btn btn--base submit-btn" data-type="draft"><i class="fa-solid fa-paper-plane"></i> @lang('Save as Draft') </button>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="tagModal" tabindex="-1" aria-labelledby="tagModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-4">
            <div class="col-lg-12 prompt_field d-none">
            ...
            {{-- Generated Tags (AI results) --}}
            <div class="col-lg-12 generated_tags_content d-none">
                <div class="generated_tags_wrapper"></div>
                <button type="button" class="btn btn--md btn--base add_hashtag d-none mt-2">@lang('Add Selected Tags')</button>
            </div>

            {{-- Manual Hashtag Input --}}
            <div class="col-lg-12 tag_input_warp">
            <input type="text" class="form-control hashtag_input" placeholder="#tag1 #tag2">
            </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn--md btn--base hashtagSubmit">@lang('Add Tags')</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn--md btn--base generate-content" data-action="{{ route('user.posts.content.generate') }}">
                    <i class="fa-solid fa-wand-magic-sparkles"></i> @lang('Generate')
                    <span class="spinner-border spinner-border-sm text-light d-none loader3" role="status"></span>
                </button>
            </div>
        ...
        (function ($) {
            ...
            $('#post-file').on('change', function(e) {
                ...
                files.forEach(file => {
                    ...
                    // Check rules: only 1 video allowed
                        ...
                        if (isImage) {
                            previewElement = `
                                <div class="media-item position-relative" data-name="${file.name}">
                                    <img src="${event.target.result}" class="preview-thumb rounded" width="120" height="120" style="object-fit: cover;">
                                    <span class="remove-media position-absolute top-0 end-0 bg-danger text-white px-2 rounded-circle" style="cursor:pointer;">×</span>
                                </div>`;
                        } else if (isVideo) {
                            previewElement = `
                                <div class="media-item position-relative" data-name="${file.name}">
                                    <video src="${event.target.result}" class="preview-thumb rounded" width="160" height="120" controls></video>
                                    <span class="remove-media position-absolute top-0 end-0 bg-danger text-white px-2 rounded-circle" style="cursor:pointer;">×</span>
                                </div>`;
                        }
            ...
            $('#postForm').on('submit', function(e) {
                ...
                notify('info', 'Uploading your post...');
                    ...
                    success: function(response) {
                        notify('success', 'Post uploaded successfully!');
        ...
        (function ($) {
            ...
            $(".generateHashtag").on("click", function () {
                ...
                success: function (response) {
                    ...
                    $(".tag_input_warp").removeClass("col-lg-12").addClass("col-lg-12");
