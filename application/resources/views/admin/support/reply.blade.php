                    ...
                    <div class="row">
                        <div class="col-sm-8 col-md-6">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <p>[@lang('Ticket#'){{ $ticket->ticket }}] {{ $ticket->subject }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="row form-group">
                                ...
                                <div class="col-3 d-flex justify-content-start align-items-center">
                                    <button type="button" class="btn btn--primary btn-sm extraTicketAttachment ms-0"><i
                                            class="fa fa-plus"></i></button>
                                </div>
                                <div class="col-12">
                                    <div id="fileUploadsContainer" class="d-flex flex-column gap-3"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    @foreach ($messages as $message)
                        @if ($message->admin_id == 0)
                            <div class="row user-reply float-end position-relative">
                                <div class="col">
                                    <p class="text-muted fw--500 my-3"><span class="text--primary">
                                            ...
                                            @else
                                                {{ $ticket->name }}
                                            @endif
                                        </span> @lang('replied on')
                                        {{ showDateTime($message->created_at,'l, dS F Y @ H:i') }}
                                    </p>
                                    ...
                                    @endif
                                    <button class="btn btn--danger btn-sm confirmationBtn position-absolute"
                                        data-question="@lang('Are you sure to delete this message?')"
                                        data-action="{{ route('admin.ticket.delete', $message->id) }}"><i class="fa-solid fa-trash-can"></i></button>
                                </div>
                            </div>
                        @else
                            <div class="row admin-reply position-relative">
                                <div class="col">
                                    <p class="text-muted fw--500 my-3">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.ticket.index') }}" class="btn btn-sm btn--primary">@lang('Back')
    </a>
@endpush
